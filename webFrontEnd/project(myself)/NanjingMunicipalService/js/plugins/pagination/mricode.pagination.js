...
(function(factory) {
    ...
    Page.prototype = {
        ...
        initHtml: function() {
            //init size module
            var sizeHtml = $('<select test-page-btn="size"></select>');
            ...
            //init jump module
            var jumpHtml = '<div class="m-pagination-group"><input test-page-btn="jump" type="text"><button test-page-btn="jump" type="button">' + this.options.jumpBtnText + '</button></div>';
            ...
            .on('click', { page: this }, function(event) {
                if ($(event.target).is('button')) {
                    if ($(event.target).data('pageBtn') == 'jump') {
                        var $input = event.data.page.$element.find('input[test-page-btn=jump]');
    ...
    pagination.core = {
        ...
        */
        ...
        renderPerPage: function(text, value) {
            return $("<li><a test-page-index='" + value + "'>" + text + "</a></li>");
        },
